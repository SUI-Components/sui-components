...
describe(json.name, () => {
  ...
  it('library should include defined exported elements', () => {
    ...
    // When
    const {default: AtomHelpText, ...others} = library
  ...
  describe(Component.displayName, () => {
    ...
    it('should extend classNames', () => {
      // Given
      const props = {className: 'extended-classNames', text: 'AtomHelpText'}
    ...
    it('should have data attributes', () => {
      // Given
      const props = {'data-attribute': 'data-attribute', text: 'AtomHelpText'}
    ...
    it('should have aria attributes', () => {
      // Given
      const props = {'aria-attribute': 'aria-attribute', text: 'AtomHelpText'}
    ...
    describe('polymorphism', () => {
      it('should render an article when `as` prop has this value', () => {
        // given
        const props = {as: 'article', text: 'AtomHelpText'}
        // when
        const {container} = setup(props)
        // then
        expect(container.innerHTML).to.be.a('string')
