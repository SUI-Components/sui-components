...
const ArticlePlaceHolder = ({className}) => {
  ...
  return (
    <Article className={className}>
      <H2>Placeholder</H2>
      <Paragraph>We can use a placeholder for the component. Each cell gonna use the placeholder we defined.</Paragraph>
      <Grid cols={2} gutter={[8, 8]} style={{width: 400}}>
        ...
        <Cell span={2}>
          <PinInput placeholder={placeholder} onChange={onChangeCodeHandler} value={code} />
        </Cell>
      </Grid>
      <br />
    </Article>
