...
const ArticleScrollUp = ({className}) => {
  ...
  return (
    <Article className={className}>
      <H2>ScrollUp</H2>
      <Paragraph>
        The BehaviorStickyScrollUp is only top stacked when the viewport
        triggered is scrolled up.
      </Paragraph>
      <BehaviorStickyProvider>
        <Box
        ...
        >
          <BehaviorStickyScrollUp container={ref}>
            <Box outline mode="dark">
              <Bold>
                This is an element wrapped by a{' '}
                <Code>BehaviorStickyScrollUp</Code> component.
              </Bold>
            </Box>
          </BehaviorStickyScrollUp>
