...
const ArticleInfiniteLoop = ({className}) => (
  <Article className={className}>
    <H2>Infinite loop</H2>
    <Paragraph>
      You could make your carousel infinite by configuring the{' '}
      <Code>hasInfiniteLoop</Code> boolean prop to true. That means when it
      arrive to the last slide, and the user clicks on next it starts again. And
      when the carousel is on the first slide, and the user clicks on previous,
      it goes to the last slide.
    </Paragraph>
