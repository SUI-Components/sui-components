...
const ArticleKeyboardNavigation = ({className}) => (
  <Article className={className}>
    ...
    <Paragraph>
      You could use the <Code>keyboardNavigation</Code> prop in order to
      activate keyboard navigation. Try to use the left and right arrow in order
      to navigate the next slider.
    </Paragraph>
