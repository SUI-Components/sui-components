...
const ArticlePreloadItems = ({className}) => (
  <Article className={className}>
    ...
    <Paragraph>
      The slider is optimized in order to be lazy loaded and, then, load the
      images only when needed so you could notice an empty image while sliding.
      You could preload as much as images as you want by using the
      <Code>itemsToPreload</Code> (number) prop in order to avoid that effect if
      you wish.
    </Paragraph>
