  ...
  return (
    <Article className={className}>
      ...
      <Paragraph>
        ...
        {`${Object.values(moleculeDropdownListDesigns).join('|')}`}) prop. Valid
        values are under <Code>moleculeDropdownListDesigns</Code> exported
        variable:{' '}
      </Paragraph>
        ...
        <Cell>
          <RadioButtonGroup
            ...
            onChange={(event, value) =>
              setDesign(design === value ? undefined : value)
            }
          >
            {[undefined, ...Object.values(moleculeDropdownListDesigns)].map(
              moleculeDropdownListDesign => (
                <RadioButton
