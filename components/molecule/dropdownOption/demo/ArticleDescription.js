...
const ArticleDescription = ({className}) => {
  ...
  return (
    <Article className={className}>
      <H2>Description</H2>
      <Paragraph>
        The <Code>description</Code> (string) prop is used to offer an extra information to the given component children
        content.
      </Paragraph>
      <Grid cell={1} gutter={[8, 8]}>
        ...
        <Cell className={CLASS_DEMO_OPTION}>
          <MoleculeDropdownOption description={description}>children</MoleculeDropdownOption>
        </Cell>
      </Grid>
    </Article>
  )
