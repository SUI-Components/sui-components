...
const ArticleContainerOverride = ({className}) => {
  ...
  return (
    <Article className={className}>
      ...
      <Paragraph>
        using <Code>overrideContainer</Code> (boolean) prop, the component can
        be placed in the desired DOM placement combined with the{' '}
        <Code>targetRef</Code> prop. If there is not ref provided it will be
