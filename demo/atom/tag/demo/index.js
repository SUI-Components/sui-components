...
const Demo = () => {
  ...
  return (
    <div style={{float: 'left'}}>
      ...
      <h2>Small Tags with types</h2>
      <p>
        <AtomTag label="Sale" size={atomTagSizes.SMALL} type="sale" />
        <AtomTag label="Special" size={atomTagSizes.SMALL} type="special" />
        <AtomTag label="5 min ago" size={atomTagSizes.SMALL} type="date" />
      </p>
